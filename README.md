...
Com mais de **20 anos de experiência** no desenvolvimento de software, construí uma carreira focada na entrega de soluções robustas e escaláveis. Atualmente, lidero equipes técnicas no desenvolvimento de aplicações de missão crítica focadas em **negócios e processos bancários**.

Minha paixão reside na interseção entre Engenharia de Software sólida e as novas fronteiras da tecnologia, como a Inteligência Artificial.
